...
def rb_analysis_combined(rb_type: str,
                         data_type: str = 'survival'):
...
def convert_params(fit_params,
    ...
    if nqubits == 2 and rb_type == '2Q_RB':
        ntq = 1.5
    elif nqubits == 2 and rb_type == 'SU4_RB':
        ntq = 1
    else:
        ntq = 1
